...
int main(int argc, char const *argv[]){    
    ...
    ArvoreB* arvoreOrdem;
    ArvoreB* arvoreAleatoria;

    for(i=0; i<100; i++){
        //criar arvores
        arvoreOrdem = criaArvore(1);
        arvoreAleatoria = criaArvore(1);
        ...
        //inserir valores
        for(j=0; j<tam; j++){
            adicionaChave(arvoreOrdem, listaOrdem[j]);
        }
        ...
        //inserir valores
        for(j=0; j<tam; j++){
            adicionaChave(arvoreAleatoria, listaAleatoria[j]);
        }
